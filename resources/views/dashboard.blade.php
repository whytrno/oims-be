            ...
            <div class="card card-carousel overflow-hidden h-100 p-0">
                <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
                    <div class="carousel-inner border-radius-lg h-100">
                        <div class="carousel-item h-100 active" style="background-image: url('{{asset("img/img-2.jpg")}}');
                    background-size: cover;">
                        ...
                        <div class="carousel-item h-100" style="background-image: url('{{asset("img/img-1.jpg")}}');
                background-size: cover;">
                            <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                        ...
                        <div class="carousel-item h-100" style="background-image: url('{{asset("img/img-3.jpg")}}');
            background-size: cover;">
                            <div class="carousel-caption d-none d-md-block bottom-0 text-start start-0 ms-5">
                                <div class="icon icon-shape icon-sm bg-white text-center border-radius-md mb-3">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="javascript:;" class="avatar rounded-circle">
                                        <img alt="Image placeholder"
                                             src="{{asset('img/small-logos/logo-asana.svg')}}">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="javascript:;" class="avatar rounded-circle">
                                        <img alt="Image placeholder"
                                             src="{{asset('img/small-logos/bootstrap.svg')}}">
                                    </a>
                                </div>
                                <div class="col">
            ...
            <div class="card h-100">
                <div class="card-header d-flex align-items-center border-bottom py-3">
                    <div class="d-flex align-items-center">
                        <a href="javascript:;">
                            <img src="{{asset('img/team-4.jpg')}}" class="avatar" alt="profile-image">
                        </a>
                        <div class="mx-3">
                ...
                <div class="card-body">
                    <p class="mb-4">
                        ...
                        recruiters to
                        continue reading your CV because you’re telling them from the off exactly why they should
                        hire you.
                    </p>
                    <img alt="Image placeholder"
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                       ...
                                       data-original-title="Jessica Rowland">
                                        <img alt="Image placeholder" src="{{asset('img/team-5.jpg')}}" class>
                                    </a>
                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                       data-toggle="tooltip"
                    ...
                    <div class="card bg-gradient-danger h-100">
                        <div class="card-body">
                            <div class="row justify-content-between align-items-center">
                                <div class="col">
                                    <img src="{{asset('img/logos/bitcoin.jpg')}}" class="w-30 border-radius-md"
                            ...
                            <div class="my-4">
                                ...
                                <div class="h6 text-white cursor-pointer" data-bs-toggle="tooltip"
                                     ...
                                     title="Copy Address">0yx8Wkasd8uWpa083Jj81qZhs923K21
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col">
                                ...
                                <div class="d-flex px-2 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                                                                                  class="__cf_email__"
                                                                                  data-cfemail="315b5e595f7152435450455847541c45585c1f525e5c">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                                                                                  class="__cf_email__"
                                                                                  data-cfemail="ddbcb1b8a5bc9dbeafb8bca9b4abb8f0a9b4b0f3beb2b0">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                                                                                  class="__cf_email__"
                                                                                  data-cfemail="7418150106111a003417061115001d021159001d195a171b19">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                                                                                  class="__cf_email__"
                                                                                  data-cfemail="e28f8b818a83878ea281908783968b9487cf968b8fcc818d8f">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0"><a href="/cdn-cgi/l/email-protection"
                                                                                  class="__cf_email__"
                                                                                  data-cfemail="f4869d979c958690b497869195809d8291d9809d99da979b99">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                            </td>
