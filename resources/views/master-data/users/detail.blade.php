            ...
            <div class="card card-body" id="profile">
                <div class="row justify-content-center align-items-center">
                    <div class="col-sm-auto col-4">
                        <div @if (Auth::user()->role_id === 1) onclick="clickImageInput()" @endif
                            class="cursor-pointer avatar avatar-xl position-relative">
            ...
            <div class="card mt-4" id="basic-info">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row row-cols-2 mt-4">
                        ...
                        @endphp
                        <x-select label="Agama" name="agama" :options="$agamaOptions" :selected="$data->profile->agama" />
                    </div>
                    <div class="row row-cols-2 mt-4" id="menikah-container">
                        ...
                        @endphp
                        <x-select label="Status Pernikahan" name="status_pernikahan" :options="$statusPernikahanOptions" :selected="$data->profile->status_pernikahan" />
                    ...
                    <div class="row row-cols-2 mt-4">
                        <x-select name="mcu" label="MCU" :options="['ada' => 'Ada', 'tidak ada' => 'Tidak Ada']" :selected="$data->profile->mcu" />
                    ...
                    <div class="row row-cols-2 mt-4">
                        ...
                        @endphp
                        <x-select label="Status Kontrak" name="status_kontrak" :options="$statusKontrakOptions" :selected="$data->profile->status_kontrak" />
                        <x-input name="lokasi_site" title="Lokasi Site" placeholder="Surabaya" type="text"
                            value="{{ $data->profile->lokasi_site }}" />
                    </div>
                    <button @if (Auth::user()->role_id !== 1) disabled @endif class="btn bg-gradient-success mt-4"
